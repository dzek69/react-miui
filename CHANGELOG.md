...
## [0.36.1] - 2026-06-17
### Fixed
- broken types from `styled()` since 0.33.0
...
### Changed
- `Modal` many accessibility improvements
- `Modal` will trap focus now
### Fixed
- `Input` component native error did not highlight in red
- some elements look broen when focused from keyboard
- `Modal` not scrolling if content too long
- `Modal` not accepting extra props
